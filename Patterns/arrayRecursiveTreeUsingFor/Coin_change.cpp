/*
Q. Given an array containaing elements or coins. They are available infinitely. Find the minimum number of elements or coins
required to make the target amount/sum
